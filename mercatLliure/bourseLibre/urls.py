...
url(r'^search/', include('haystack.urls'), name='haystack_search'),
    ...
    url(r'^accounts/profil/inconnu/$', views.profil_inconnu, name='profil_inconnu',),
    url(r'^accounts/profil/modifier/$', views.profil_modifier, name='profil_modifier',),
    url(r'^accounts/profil/contact/(?P<user_id>[0-9]+)/$', views.profil_contact, name='profil_contact',),
